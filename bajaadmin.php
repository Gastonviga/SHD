    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($DNI > 0) {
                ...
                // Consultar la existencia del admin en la base de datos
                $sqlExistencia = $conexion->prepare("SELECT DNI, NombreYApellido, Puesto, Usuario, Contra, Numero, apikey FROM administrador WHERE DNI = ?");
                ...
                if ($sqlExistencia->num_rows > 0) {
                    ...
                    // Vincular resultados
                    $sqlExistencia->bind_result($DNI, $NombreYApellido, $Puesto, $Usuario, $Contra, $Numero, $apikey);
                    ...
                    echo "<p>¿Estás seguro de eliminar al administrador con los siguientes datos?</p>";
                    ...
                    echo "<form method='post' action='baja2admin.php'>";
